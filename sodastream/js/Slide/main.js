...
;(function(window) {
	...
	CircleSlideshow.prototype._init = function() {
		...
		this.navLeftCtrl.innerHTML = '<svg width="100px" height="30px" viewBox="0 0 100 30"><polyline class="navbutton__line" fill="none"/></svg>';
		...
		this.navRightCtrl.innerHTML = '<svg width="100px" height="30px" viewBox="0 0 100 30"><polyline class="navbutton__line" fill="none"/></svg>';
